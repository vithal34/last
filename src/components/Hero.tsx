        ...
        <div className="flex items-center w-full lg:w-1/2">
          <div className="max-w-2xl mb-8">
            ...
            <div className="flex flex-col items-start space-y-3 sm:space-x-4 sm:space-y-0 sm:items-center sm:flex-row">
              <a
                href="https://forms.gle/PdHC5RikZz9yWwe88"
                target="_blank"
                rel="noopener"
      ...
      <Container>
        <div className="flex flex-col justify-center">
          <div className="text-xl text-center text-gray-700 dark:text-white">
            Experience <span className="text-indigo-600 font-bold">simulated investing</span>{" "}
            in <span className="text-indigo-600 font-bold">real life businesses</span> from around the world
          </div>
