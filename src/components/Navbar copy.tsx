...
export const Navbar = () => {
  const navigation = [
    ...
    // { text: "Startups", url: "http://localhost:5173/signup" },
    { text: "Invest Now", url: "" },
    // { text: "Take A Quiz", url: "http://forms.google.com" },
  ...
  return (
    <div className="w-full">
      <nav className="container relative flex flex-wrap items-center justify-between p-8 mx-auto lg:justify-between xl:px-0">
              ...
              <div className="flex flex-wrap items-center justify-between w-full lg:w-auto">
                  ...
                  <>
                    {navigation.map((item, index) => (
                      <Link key={index} href={item.url}>
                        <div className="w-full px-4 py-2 -ml-4 text-gray-500 rounded-md dark:text-gray-300 hover:text-indigo-500 focus:text-indigo-500 focus:bg-indigo-100 dark:focus:bg-gray-800 focus:outline-none">
                          {item.text}
                        </div>
                      </Link>
                    ))}
                ...
                <Disclosure.Panel className="flex flex-wrap w-full my-5 lg:hidden">
                  <>
                    ...
                    <Link href="https://empowerinvest.onrender.com/login">
                      <div className="w-full px-6 py-2 mt-3 text-center text-white bg-indigo-600 rounded-md lg:ml-5">
                        <Link href="https://empowerinvest.onrender.com/login">Get Started</Link>
                      </div>
                    </Link>
                  </>
                </Disclosure.Panel>
        ...
        <div className="hidden lg:flex nav__item space-x-7">
          <Link href="">
