  ...
  return (
    <Container>
      ...
      <SectionTitle
        ...
        title="Learn how to use the application"
      >
      ...
      <SectionTitle preTitle="" title="Reach Out To Us"><br />
...
{/* <div className="flex flex-wrap items-center justify-between w-full max-w-4xl gap-5 mx-auto text-white px-7 py-2 lg:px-5 lg:py-2 lg:flex-nowrap rounded-xl">
<Image
              src={timeLine}
              width="5500"
              height="1000"
