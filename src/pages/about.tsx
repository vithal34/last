...
import teamMember4 from "../../public/img/user1.jpg"; // Added
import teamMember5 from "../../public/img/user2.jpg"; // Added
import teamMember6 from "../../public/img/user3.jpg"; // Added
import teamMember7 from "../../public/img/user1.jpg"; // Added
